    ...
    },
    {
        ...
        label: (
            <a
                ...
                rel="noopener noreferrer"
            >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-4 h-4 text-white">
...
const HeaderDrop = () => (
    <Dropdown overlay={menu} trigger={['click']}>
        <div onClick={(e) => e.preventDefault()} className="relative inline-block text-custom-white text-sm xl:text-lg syne-header group custom-dropdown-trigger">
            ILETISIM
